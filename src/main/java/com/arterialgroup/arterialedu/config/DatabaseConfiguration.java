...
@Configuration
@EnableJpaRepositories("com.arterialgroup.arterialedu.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.arterialgroup.arterialedu.config.HerokuDatabaseConfiguration")
