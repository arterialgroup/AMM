...
public class AccountResource {
    ...
    public ResponseEntity<?> registerAccount(@Valid @RequestBody UserDTO userDTO, HttpServletRequest request) {
        return userRepository.findOneByLogin(userDTO.getLogin())
            ...
            .orElseGet(() -> userRepository.findOneByEmail(userDTO.getEmail())
                ...
                .orElseGet(() -> {
                    User user = userService.createUserInformation(userDTO.getLogin(), userDTO.getPassword(), userDTO.getAccreditation(), userDTO.getAccreditationType(),
                    userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail().toLowerCase(), userDTO.getState(),
                    userDTO.getLangKey());
        ...
        return Optional.ofNullable(userService.getUserWithAuthorities())
            .map(user -> new ResponseEntity<>(
                new UserDTO(
                    ...
                    user.getLogin(),
                    null,
                    user.getAccreditation(),
                    user.getAccreditationType(),
                    user.getFirstName(),
                    user.getLastName(),
                    user.getEmail(),
                    user.getState(),
    ...
    public ResponseEntity<String> saveAccount(@RequestBody UserDTO userDTO) {
        return userRepository
            ...
            .map(u -> {
                userService.updateUserInformation(userDTO.getAccreditation(), userDTO.getAccreditationType(), userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(), userDTO.getState());
