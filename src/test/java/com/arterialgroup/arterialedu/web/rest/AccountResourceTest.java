...
import com.arterialgroup.arterialedu.service.MailService;
import com.arterialgroup.arterialedu.service.UserService;
...
public class AccountResourceTest {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        User user = new User();
        user.setLogin("test");
        user.setAccreditation("123456");
        user.setAccreditationType("RACGP");
        ...
        restUserMockMvc.perform(get("/api/account")
                ...
                .andExpect(jsonPath("$.accreditation").value("123456"))
                .andExpect(jsonPath("$.accreditationType").value("RACGP"))
    ...
    @Test
    @Transactional
    public void testRegisterLoginWithEmail() throws Exception {
        UserDTO u = new UserDTO(
        		null,
            "funky@example.com",          // login <-- valid email
            "password",             // password
            "accreditation",        // accreditation
            "accreditationType",    // accreditationType
            "Funky",                // firstName
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        UserDTO dup = new UserDTO(null, u.getLogin(), u.getPassword(), u.getAccreditation(), u.getAccreditationType(), u.getLogin(), u.getLastName(),
            "alicejr@example.com", u.getState(), u.getLangKey(), u.getRoles());
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        UserDTO dup = new UserDTO(null, "johnjr", u.getPassword(), u.getAccreditation(), u.getAccreditationType(), u.getLogin(), u.getLastName(),
            u.getEmail(), u.getState(), u.getLangKey(), u.getRoles());
