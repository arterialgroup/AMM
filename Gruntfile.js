// Generated on 2015-05-13 using generator-jhipster 2.10.1
'use strict';
var fs = require('fs');
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            templates: {
                files: ['src/main/webapp/scripts/app/myLearning/**/*.html'],
                tasks: ['watch']
            }
            // html: {
            //     files: ['src/main/webapp/scripts/app/myLearning/**/*.html'],
        ...
        // not used since Uglify task does autoprefixer,
           ...
           dist: {
                files: {
                    'src/main/webapp/assets/styles/main.css' : 'src/main/webapp/assets/styles/main.css'
                }
            ...
            dev: {
                bsFiles: {
                    src : [
                        ...
                        'src/main/webapp/scripts/app/**/*.html',
                        'src/main/webapp/scripts/app/myLearning/partials/*.html',
