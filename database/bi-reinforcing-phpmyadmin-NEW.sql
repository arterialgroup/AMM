...
SELECT 
'NEWTEST - National Symposium for General Practitioners Optimising Safety of NOACs in Clinical Practice Trials, Tribulations and Truths',
...
/*-------------------------------------------------------------------*/
INSERT INTO questiongroup(text) VALUES ('BBased on what you learned during the meeting, please indicate how your recommendation of the following antithrombotic therapies has changed? (tick one box for each therapeutic option)');
...
SELECT
'No antithrombotic therapy - new',
1,
0,
(SELECT id FROM question_type WHERE name LIKE 'RAD%'),
id,
(SELECT id FROM questiongroup WHERE text = 'BBased on what you learned during the meeting, please indicate how your recommendation of the following antithrombotic therapies has changed? (tick one box for each therapeutic option)')
FROM step
WHERE name = 'Question One - rei';
...
id
FROM question
WHERE text = 'No antithrombotic therapy - new';
